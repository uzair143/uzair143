...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html"><b>T<br>H<br>E</b>Big Store<span>The Best Market</span></a></h1>
			</div>
			<?php
	...
	<div class="container">
		...
		<div class=" contact-w3">	
			...
			<div class="col-md-7 contact-left">
				...
				<p> Big Store is the world's leading classifieds platform which provides local communities in high-growth markets with vibrant online marketplaces:
				Big Store connects local people to buy, sell or exchange used goods and services by making it fast and easy for anyone to post a listing through their mobile phone or on the web.</p>
				<ul class="contact-list">
					<li> <i class="fa fa-map-marker" aria-hidden="true"></i> District Khanewal,Devision Multan.</li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com">wqararshad0@gmail.com</a></li>
					<li> <i class="fa fa-phone" aria-hidden="true"></i>03081302019</li>
				</ul>
				<div id="container">
					<!--Horizontal Tab-->
					<div id="parentHorizontalTab">
						...
						<div class="resp-tabs-container hor_1">
							...
							<div>
								...
								<h5>Our Branches</h5>
									<ul>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>123 quaid-e-azam road karachi, Pakistan.</li>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>143 bosan road multan, pakistan.</li>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>163 bahriya town lahore, pakistan.</li>
										<li><i class="fa fa-arrow-right" aria-hidden="true"></i>183 murree road islamabad,pakistan.</li>
									</ul>
								</div>
							</div>
							<div>
