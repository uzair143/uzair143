...
$sel=query("select * from ads where a_id='{$_GET['a_id']}'");
?>
<!--
Author: W3layouts
...
function hideURLbar(){ window.scrollTo(0,180); } </script>
<!-- //for-mobile-apps -->
...
<div class="header">
 ...
 <!--banner-->
 <?php
	   			$ad=mysqli_fetch_assoc($sel);
	   			
	   			$user=fetch(query("select * from users where u_id='{$ad['u_id']}'"));
	   			$country=fetch(query("select * from countries where id='{$ad['country_id']}'"));
	   			$state=fetch(query("select * from states where id='{$ad['state_id']}'"));
	   			$city=fetch(query("select * from cities where id='{$ad['city_id']}'"));
	   			?>
<div class="banner-top">
	<div class="container">
		<h3 ><?php echo $ad['a_title']; ?></h3>
		<h4><a href="index.php">Home</a><label>/</label><?php echo $ad['a_title']; ?></h4>
...
<div id="picture-frame">
			<img src="uploads/<?php echo $ad['a_img'];  ?>" data-src="uploads/<?php echo $ad['a_img'];  ?>" alt="" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3><?php echo $ad['a_title'];  ?></h3>
				 ...
				 <div class="pr-single">
				  <p class="reduced ">Price:$<?php echo $ad['a_price'];  ?></p>
				</div>
				<div class="block block-w3">
					<div class="in-pa">Posted By:<?php echo $user['u_name'];  ?> </div>
				</div>
				<div class="block block-w3">
					<div class="in-pa">Posted on:<?php echo $ad['a_date'];  ?> </div>
				</div>
				<div class="block block-w3">
					<div class="in-pa">Country:<?php echo $country['name'];  ?> </div>
				</div>
								<div class="block block-w3">
					<div class="in-pa">State:<?php echo $state['name'];  ?> </div>
				</div>
								<div class="block block-w3">
					<div class="in-pa">City:<?php echo $city['name'];  ?> </div>
				</div>

				<p class="in-pa"> <?php echo $ad['a_desc'];  ?></p>
				...
				Phone:
					<div class="add add-3">
										   ...
										   <button class="btn btn-danger  my-cart-b"><?php echo $user['u_phone'];  ?></button>
										   <?php


										   if(!isset($_SESSION['is_login']))
										   {
										   	echo '<a href="login.php"><button class="btn btn-danger  my-cart-b">Login to Send Message</button></a>';
										   }
										   ?>
										</div>
		 ...
		 if(isset($_SESSION['is_login']))
					  {
										   ...
										   <br>
										   <div class="msg">
										   	<h4>Send Message to <?php echo $user['u_name'];  ?></h4>
										   <form method="post" action="actions/send_msg.php">
										   	...
										   	<input type="hidden" name="to" value="<?php echo $user['u_id']?>">
